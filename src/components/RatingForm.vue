<template>
    <div  id="mainForm" ref="showDiv" class="p-6 max-w-sm bg-[#1f2630] rounded-3xl shadow-md text-left">
      <!-- SVG Icon -->
      <div>
...
<script setup>
  ...
  const handleSubmitClicked = async () => {
      const submitted = active.value

      console.log(submitted)
      
      showDiv.value.classList.add('hidden')

      hiddenDiv.value.classList.remove('hidden')
